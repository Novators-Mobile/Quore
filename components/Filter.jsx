      ...
      <GestureDetector gesture={pan}>
        ...
        >
          ...
          <Main>
            ...
            >
              <Title style={{ color: '#313131', fontSize: 20 }}>Мужской</Title>
              <Title style={{ color: '#313131', fontSize: 20 }}>Женский</Title>
              <Title style={{ color: '#313131', fontSize: 20 }}>Любой</Title>
            </View>
            <FullForm>
              <LabelContainer>
                <AboutMe>Искать рядом</AboutMe>
              </LabelContainer>
              <Form
                style={{
                  alignItems: 'center',
              ...
              >
                ...
                >
                  <SvgXml xml={nav} width="35px" height="30px" />
                  <Txt style={{ width: 240, textAlign: 'left' }}>
