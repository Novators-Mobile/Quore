...
export function Chats({ navigation }) {
  return (
    <Container>
      ...
      <Main>
        <ChatsBlock>
          <Avatar source={require('../assets/icons/avatar2.png')} />
          <View
            style={{
              display: 'flex',
          ...
          >
            <Title style={{ fontSize: 16 }}>Любитель рыбов</Title>
            <Txt style={{ textAlign: 'left', сolor: '#D9D9D9', fontSize: 10 }}>
              Красивое...
            </Txt>
          </View>
          <Txt style={{ textAlign: 'left', сolor: '#D9D9D9' }}>1 мин</Txt>
        </ChatsBlock>
      </Main>
      <Footer>
        <Nav>
